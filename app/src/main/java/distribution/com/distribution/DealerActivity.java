...
public class DealerActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonRedeems).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.btnValidate).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(DealerActivity.this, android.R.layout.select_dialog_singlechoice);
    ...
    private void poin() {
        class UserLogin2 extends AsyncTask<Void, Void, String> {
                    ...
                    switch(status) {
                        ...
                        case "1":
                            ...
                            User2 user2 = new User2(
                                    userJson.getString("total_poin")
                            );



                            textpoint.setText(user2.getPoin());
            ...
            protected String doInBackground(Void... voids) {
                final User user = SharedPrefManager.getInstance(DealerActivity.this).getUser();
                    ...
                    switch(status) {
                        ...
                        case "1":
                            ...
                            for (String name : Hash_file_maps.keySet()) {
                                ...
                                TextSliderView textSliderView = new TextSliderView(DealerActivity.this);
                                textSliderView
                                        .image(Hash_file_maps.get(name))
                                        .setScaleType(BaseSliderView.ScaleType.Fit)
                                        .setOnSliderClickListener(DealerActivity.this);
                            ...
                            sliderLayout.addOnPageChangeListener(DealerActivity.this);
                            poin();
    ...
    private void gettoko() {
        class UserLogin2 extends AsyncTask<Void, Void, String> {
                ...
                try {
                    ...
                    switch(status) {
                        ...
                        case "1":
                            ...
                            JSONObject json2 = json1.getJSONObject("dealer");
                            JSONObject json3 = json1.getJSONObject("user");


                            String toko = json2.getString("id");
                            String nama = json2.getString("name");
                            String owner = json3.getString("name");
                            User users = SharedPrefManager.getInstance(DealerActivity.this).getUser();
                            String role = users.getRole().toString();
                            ...
                            User2 user = new User2(toko);
                            SharedPrefManager2.getInstance(getApplicationContext()).userLogin(user);

                            textname.setText(owner);
                            textrole.setText(nama);
            ...
            protected String doInBackground(Void... voids) {
                //creating request handler object
                RequestHandler requestHandler = new RequestHandler();
                User user = SharedPrefManager.getInstance(DealerActivity.this).getUser();
                String salt = user.getSalt();
                //creating request parameters
                HashMap<String, String> params = new HashMap<>();
                params.put("user_id", salt);
